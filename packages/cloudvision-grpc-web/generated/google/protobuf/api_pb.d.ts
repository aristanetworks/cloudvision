...
export class Api extends jspb.Message {
  ...
  getSyntax(): google_protobuf_type_pb.SyntaxMap[keyof google_protobuf_type_pb.SyntaxMap];
  setSyntax(value: google_protobuf_type_pb.SyntaxMap[keyof google_protobuf_type_pb.SyntaxMap]): void;
...
export namespace Api {
  export type AsObject = {
    ...
    syntax: google_protobuf_type_pb.SyntaxMap[keyof google_protobuf_type_pb.SyntaxMap],
  }
}
